...
coverAlt: 'Cartaz "Informação muda decisões — dados + conhecimento + sistemas = valor econômico": um banco de dados central ligado a empresas, gestão pública e Justiça, com setas para decisões e valor econômico.'
tags:
...
- Prêmio de Ciências Econômicas em Memória de Alfred Nobel de 2001 (Akerlof, Spence e Stiglitz), pelas análises de mercados com informação assimétrica: [resumo oficial](https://www.nobelprize.org/prizes/economic-sciences/2001/summary/).

## Sites para acesso

- [Lei de Acesso à Informação (Lei nº 12.527/2011)](https://www.planalto.gov.br/ccivil_03/_ato2011-2014/2011/lei/l12527.htm): a transparência pública como redução de assimetria entre Estado e cidadão.
- [Lei Geral de Proteção de Dados (Lei nº 13.709/2018)](https://www.planalto.gov.br/ccivil_03/_ato2015-2018/2018/lei/l13709.htm): limites jurídicos para a coleta e o uso de informações pessoais.
- [Portal Brasileiro de Dados Abertos](https://dados.gov.br/): bases públicas para análise e para o desenvolvimento de sistemas.
- [DataJud — Base Nacional de Dados do Poder Judiciário (CNJ)](https://www.cnj.jus.br/sistemas/datajud/): exemplo de sistema de informação que muda decisões de gestão na Justiça.
