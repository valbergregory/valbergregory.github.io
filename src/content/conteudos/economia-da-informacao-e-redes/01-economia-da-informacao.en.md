...
subtitle: With data, knowledge and networks we create value.
summary: Information economics studies how information and knowledge shape decisions, markets, contracts and forms of productive organisation. In the digital economy, information stops being an auxiliary resource and becomes an economic asset, a productive input and a source of power.
lang: en
slug: information-economics
type: serie
series: economia-da-informacao-e-redes
order: 1
cover: ./economia-da-informacao-capa.webp
coverAlt: 'Poster "Information economics — how data, knowledge and networks create value": a network sphere with nodes and connections linked to icons of a database, a document, a head with a light bulb and a growth chart.'
tags:
...
- Goldfarb, A.; Tucker, C. (2019). "Digital Economics". *Journal of Economic Literature*, 57(1), 3–43. [doi:10.1257/jel.20171452](https://doi.org/10.1257/jel.20171452) — A modern survey: the digital economy as a fall in the costs of search, replication, transport, tracking and verification.
- Brynjolfsson, E.; McAfee, A. (2014). *The Second Machine Age*. New York: W. W. Norton.

## Websites to explore

- [Cetic.br — Regional Center for Studies on the Development of the Information Society](https://cetic.br/en/): the ICT Households, ICT Enterprises and ICT Electronic Government surveys, the main source of data on technology use in Brazil.
- [UNCTAD — Digital Economy Report](https://unctad.org/topic/ecommerce-and-digital-economy/digital-economy-report): periodic report on the digital economy in developing countries.
- [OECD — Digital economy](https://www.oecd.org/en/topics/digital-economy.html): indicators, policies and the *Digital Economy Outlook*.
- [NBER — Economics of Digitization](https://www.nber.org/programs-projects/projects-and-centers/economics-digitization): recent working papers on the digital economy.
