...
order: 6
cover: ./versionamento.webp
coverAlt: 'Cartaz "Versionamento — um produto, diferentes níveis de valor": três planos lado a lado, Básico, Pro e Empresarial, cada um com mais itens marcados que o anterior, ligados por uma seta ascendente. Legenda: segmentar a disposição a pagar.'
tags:
...
- Shapiro, C.; Varian, H. R. (1998). "Versioning: The Smart Way to Sell Information". *Harvard Business Review*, novembro–dezembro de 1998. [hbr.org](https://hbr.org/1998/11/versioning-the-smart-way-to-sell-information)
- Varian, H. R. (1997). "Versioning Information Goods". Working paper, University of California, Berkeley. — Base teórica da estratégia.
- Deneckere, R. J.; McAfee, R. P. (1996). "Damaged Goods". *Journal of Economics & Management Strategy*, 5(2), 149–174. [doi:10.1111/j.1430-9134.1996.00149.x](https://doi.org/10.1111/j.1430-9134.1996.00149.x) — Por que vale a pena degradar deliberadamente um produto.
- Bhargava, H. K.; Choudhary, V. (2008). "When Is Versioning Optimal for Information Goods?" *Management Science*, 54(5), 1029–1035. [doi:10.1287/mnsc.1070.0773](https://doi.org/10.1287/mnsc.1070.0773)
- Varian, H. R. (1989). "Price Discrimination". In: *Handbook of Industrial Organization*, vol. 1, pp. 597–654. — Panorama da discriminação de preços.

## Sites para acesso

- [LinkedIn Premium](https://premium.linkedin.com/) e [Comparativo de edições do Windows](https://www.microsoft.com/pt-br/windows/compare-windows-11-home-vs-pro-versions): as páginas de planos são um exercício prático de leitura de versionamento — o que muda entre versões e quanto isso custa.
- [Código de Defesa do Consumidor (Lei nº 8.078/1990)](https://www.planalto.gov.br/ccivil_03/leis/l8078compilado.htm): informação clara sobre o que cada versão inclui é dever legal no Brasil.
