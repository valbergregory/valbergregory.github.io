...
order: 9
cover: ./poder-digital-e-regulacao.webp
coverAlt: 'Cartaz "Poder digital e regulação": uma balança com uma grande plataforma cercada de usuários de um lado e várias empresas menores com uma porta de saída do outro; abaixo, os ícones efeitos de rede, dados, interoperabilidade e escolha do usuário. Legenda: inovação com concorrência e direitos.'
tags:
  - Regulação
  - Concorrência
...
Por conseguinte, regular mercados digitais exige preservar os benefícios da inovação sem ignorar as condições que permitem a concentração de poder. O objetivo deve ser assegurar concorrência efetiva, direitos dos usuários e possibilidade real de escolha, com medidas proporcionais aos riscos e às características de cada mercado.

## Para aprofundar

- Crémer, J.; de Montjoye, Y.-A.; Schweitzer, H. (2019). *Competition Policy for the Digital Era*. Bruxelas: Comissão Europeia. [Relatório](https://op.europa.eu/en/publication-detail/-/publication/21dc175c-7b76-11e9-9f05-01aa75ed71a1)
- Furman, J. et al. (2019). *Unlocking Digital Competition: Report of the Digital Competition Expert Panel*. Londres: HM Treasury. [Relatório](https://www.gov.uk/government/publications/unlocking-digital-competition-report-of-the-digital-competition-expert-panel)
- Stigler Committee on Digital Platforms (2019). *Final Report*. Chicago: Stigler Center, University of Chicago Booth School of Business. [Relatório](https://www.chicagobooth.edu/research/stigler/news-and-media/committee-on-digital-platforms-final-report)
- Khan, L. M. (2017). "Amazon's Antitrust Paradox". *Yale Law Journal*, 126(3), 710–805. — A crítica ao critério de preço como medida única de bem-estar do consumidor.
- Departamento de Estudos Econômicos do CADE (2020). *Concorrência em mercados digitais: uma revisão dos relatórios especializados*. Documento de Trabalho nº 5/2020. Brasília: CADE.
- Shapiro, C.; Varian, H. R. (1999). *Information Rules*, capítulo 9 ("Waging a Standards War") e capítulo 10 ("Information Policy").

## Sites para acesso

- [Regulamento (UE) 2022/1925 — Digital Markets Act](https://eur-lex.europa.eu/eli/reg/2022/1925/oj) e [página oficial do DMA](https://digital-markets-act.ec.europa.eu/).
- [Regulamento (UE) 2022/2065 — Digital Services Act](https://eur-lex.europa.eu/eli/reg/2022/2065/oj).
- [PL 2.768/2022 — regulação de plataformas digitais (Câmara dos Deputados)](https://www.camara.leg.br/propostas-legislativas/2337417).
- [Lei Geral de Proteção de Dados (Lei nº 13.709/2018)](https://www.planalto.gov.br/ccivil_03/_ato2015-2018/2018/lei/l13709.htm) e [Autoridade Nacional de Proteção de Dados (ANPD)](https://www.gov.br/anpd/pt-br).
