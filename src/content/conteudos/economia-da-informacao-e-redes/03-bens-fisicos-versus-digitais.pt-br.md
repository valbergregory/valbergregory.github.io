...
order: 3
cover: ./bens-fisicos-versus-digitais.webp
coverAlt: 'Cartaz "Bens físicos × bens digitais": à esquerda, um livro (rival) distribuído a três pessoas e ligado a engrenagens, madeira e fábrica; à direita, um arquivo (não rival) aberto ao mesmo tempo em notebook, monitor, tablet e celular. Legenda: copiar informação custa quase zero.'
tags:
...
Desse modo, a diferença econômica entre bens físicos e digitais explica por que mercados de informação desenvolvem formas próprias de preço, acesso e distribuição. Para quem projeta sistemas, compreender essa estrutura é essencial para escolher modelos de negócio coerentes e regras de acesso proporcionais ao valor e aos direitos envolvidos.

## Para aprofundar

- Shapiro, C.; Varian, H. R. (1999). *Information Rules*. Boston: Harvard Business School Press. — Capítulos 1 a 3: bens de informação, custos e precificação.
- Samuelson, P. A. (1954). "The Pure Theory of Public Expenditure". *Review of Economics and Statistics*, 36(4), 387–389. [doi:10.2307/1925895](https://doi.org/10.2307/1925895) — A origem da distinção entre bens rivais e não rivais.
- Romer, P. M. (1990). "Endogenous Technological Change". *Journal of Political Economy*, 98(5), S71–S102. [doi:10.1086/261725](https://doi.org/10.1086/261725) — Ideias como bens não rivais e o crescimento econômico.
- Goldfarb, A.; Tucker, C. (2019). "Digital Economics". *Journal of Economic Literature*, 57(1), 3–43. [doi:10.1257/jel.20171452](https://doi.org/10.1257/jel.20171452)

## Sites para acesso

- [Creative Commons](https://creativecommons.org/): licenças que exploram a não rivalidade para permitir cópia e reúso com regras claras.
- [Open Source Initiative](https://opensource.org/): definição de software livre/aberto e licenças aprovadas.
- [Marco Civil da Internet (Lei nº 12.965/2014)](https://www.planalto.gov.br/ccivil_03/_ato2011-2014/2014/lei/l12965.htm): princípios para o uso da internet no Brasil, inclusive neutralidade de rede e responsabilidade por conteúdo.
