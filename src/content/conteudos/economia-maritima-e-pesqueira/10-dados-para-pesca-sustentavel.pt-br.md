...
coverAlt: 'Capa "Dados para uma pesca sustentável — tecnologia, governança e conhecimento local": um satélite ligado por linha tracejada a um barco, um banco de dados, um gráfico de linha e duas pessoas. Legenda: monitorar, fiscalizar, planejar e adaptar.'
tags:
  - Economia Pesqueira
...
- Ostrom, E. (1990). *Governing the Commons*. Cambridge: Cambridge University Press. [doi:10.1017/CBO9780511807763](https://doi.org/10.1017/CBO9780511807763) — Sem governança, dados não viram gestão.
- Lei nº 13.709/2018 (LGPD): [texto integral](https://www.planalto.gov.br/ccivil_03/_ato2015-2018/2018/lei/l13709.htm) — Dados de pescadores e embarcações são dados pessoais.

## Sites para acesso

- [Global Fishing Watch](https://globalfishingwatch.org/): mapa aberto do esforço de pesca global reconstruído a partir de sinais AIS.
- [Copernicus Marine Service](https://marine.copernicus.eu/): dados oceanográficos abertos (temperatura, correntes, clorofila).
- [NOAA — Optimum Interpolation SST (OISST)](https://www.ncei.noaa.gov/products/optimum-interpolation-sst): série diária de temperatura da superfície do mar usada para detectar ondas de calor marinhas.
- [NOAA Coral Reef Watch](https://coralreefwatch.noaa.gov/): alertas de estresse térmico em recifes.
- [Ministério da Pesca e Aquicultura](https://www.gov.br/mpa/pt-br): PREPS, RGP e estatística pesqueira.
