...
coverAlt: 'Cover "Maritime economics — well beyond ships": a ship surrounded by a port crane, a wind turbine, a gear, a fish and a communications antenna. Caption: ports, fisheries, energy, logistics and technology.'
tags:
  - Maritime Economics
  - Ports
  - Logistics
...
- Notteboom, T.; Pallis, A.; Rodrigue, J.-P. (2022). *Port Economics, Management and Policy*. New York: Routledge. — Online version for educational use at [porteconomicsmanagement.org](https://porteconomicsmanagement.org/).

## Websites to explore

- [Brazilian Navy — Blue Amazon and blue economy](https://www.marinha.mil.br/economia-azul/).
- [Interministerial Commission for Marine Resources (CIRM)](https://www.marinha.mil.br/secirm/): coordination of the PSRM and of marine-resource programmes.
- [NOAA — Economics: National Ocean Watch (ENOW)](https://coast.noaa.gov/digitalcoast/data/enow.html): an example of a system that measures the ocean economy by sector and county in the United States.
- [European Commission — EU Blue Economy Report](https://oceans-and-fisheries.ec.europa.eu/ocean/blue-economy_en): the annual report on the European blue economy.
