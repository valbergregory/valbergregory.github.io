...
order: 8
cover: ./bioeconomia-da-pesca.webp
coverAlt: 'Capa "Bioeconomia da pesca — pescar mais nem sempre gera mais valor": gráfico com a curva de captura em forma de parábola contra o esforço de pesca, uma linha reta de custo e o ponto de rendimento máximo sustentável (RMS). Legenda: esforço, estoque, custos e renda.'
tags:
  - Economia Pesqueira
  - Bioeconomia
  - Modelos Econômicos
...
- Seijo, J. C.; Defeo, O.; Salas, S. (1998). *Fisheries Bioeconomics: Theory, Modelling and Management*. FAO Fisheries Technical Paper 368. Roma: FAO. [Texto integral](https://www.fao.org/4/w6914e/w6914e00.htm) — Há versão em espanhol (1997), útil para turmas de graduação.
- Anderson, L. G.; Seijo, J. C. (2010). *Bioeconomics of Fisheries Management*. Ames: Wiley-Blackwell.
- Grafton, R. Q. et al. (2007). "Economics of Overexploitation Revisited". *Science*, 318(5856), 1601. [doi:10.1126/science.1146017](https://doi.org/10.1126/science.1146017) — Por que o ótimo econômico costuma exigir estoques maiores que o RMS.

## Sites para acesso

- [FAO — FishStat](https://www.fao.org/fishery/en/statistics): estatísticas mundiais de captura e aquicultura, por espécie e país.
- [RAM Legacy Stock Assessment Database](https://www.ramlegacy.org/): base aberta de avaliações de estoques pesqueiros no mundo.
- [Sea Around Us](https://www.seaaroundus.org/): reconstruções de capturas por país e zona econômica exclusiva.
