...
Três compromissos atravessam tudo o que faço: usar dados públicos sempre que possível, com atenção à sua cobertura e às suas falhas; documentar o método para que outra pessoa possa reproduzir o resultado; e devolver o que a pesquisa produz — em forma de aula, painel, boletim ou parecer — para quem precisa decidir. Muitos dos projetos descritos neste site estão em andamento. Os resultados podem mudar após novas validações, e este site é atualizado para refletir isso.
